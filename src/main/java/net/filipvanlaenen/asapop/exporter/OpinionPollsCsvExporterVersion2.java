...
/**
 * Exporter of opinion polls to version 2 of the CSV file format.
 */
public final class OpinionPollsCsvExporterVersion2 extends CsvExporter {
    /**
     ...
     * Private constructor.
     */
    private OpinionPollsCsvExporterVersion2() {
    }
    ...
    public static String export(final OpinionPolls opinionPolls, final String area, final String includeAreaAsNational,
        ...
        sb.append(",Other\n");
        List<OpinionPoll> sortedPolls = sortOpinionPolls(opinionPolls.getOpinionPolls());
        int ephemeralId = sortedPolls.size();
        for (OpinionPoll opinionPoll : sortedPolls) {
            String lines =
                    export(opinionPoll, ephemeralId, area, includeAreaAsNational, electoralListIdSets, candidateIds);
            if (lines != null) {
                sb.append(lines);
                sb.append("\n");
            }
     ...
     */
    static String export(final OpinionPoll opinionPoll, final int ephemeralId, final String area,
