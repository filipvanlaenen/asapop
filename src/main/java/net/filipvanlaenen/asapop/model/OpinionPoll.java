...
public final class OpinionPoll {
	...
	public static class Builder {
		 ...
		 *
		 * @param electoralListKey The key of an electoral list.
		 * @param wellformedResult The result value as a text, assumed to be
		 *                         well-formed.
		 * @return This builder instance.
		 */
	...
	/**
	 * Returns the effective sample size. The effective sample size is the sample
	 * size minus the excluded responses.
	 *
