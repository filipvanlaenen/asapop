...
public class MalformedDateWarning extends ParserWarning {
     ...
     */
    MalformedDateWarning(final int lineNumber, final String key, final String value) {
        super(lineNumber);
        this.key = key;
        this.value = value;
    }
    ...
    public boolean equals(final Object obj) {
        if (obj instanceof MalformedDateWarning) {
            MalformedDateWarning otherWarning = (MalformedDateWarning) obj;
    ...
    public String toString() {
        return "Malformed date (“" + value + "”) detected for metadata field “" + key + "” in line " + getLineNumber()
                + ".";
    }
}
