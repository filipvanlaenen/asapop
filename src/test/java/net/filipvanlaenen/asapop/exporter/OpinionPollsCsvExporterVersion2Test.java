...
/**
 * Unit tests on the class <code>OpinionPollsCsvExporterVersion2</code>.
 */
public class OpinionPollsCsvExporterVersion2Test {
    /**
     ...
     */
    private static final Token TOKEN = Laconic.LOGGER.logMessage("Unit test OpinionPollsCsvExporterVersion2.");
    ...
    public void shouldExportMinimalOpinionPoll() {
        ...
        expected.append("Ephemeral Poll ID,Ephemeral Response Scenario ID,Polling Firm,Commissioners,Fieldwork Start");
        expected.append(",Fieldwork End,Scope,Sample Size,Sample Size Qualification,Participation,Precision,AP,BL");
        expected.append(",Other\n");
        expected.append("1,1,ACME,,2021-07-27,2021-07-27,Not Available,Not Available,Not Available");
        expected.append(",Not Available,1%,55%,45%,Not Available\n");
        assertEquals(expected.toString(), OpinionPollsCsvExporterVersion2.export(opinionPolls, null, null, A_AND_B_IDS,
                OrderedCollection.<String>empty()));
    }
    ...
    public void shouldExportWithCombinedElectoralListsAbbreviation() {
        ...
        StringBuffer expected = new StringBuffer();
        expected.append("Ephemeral Poll ID,Ephemeral Response Scenario ID,Polling Firm,Commissioners,Fieldwork Start");
        expected.append(",Fieldwork End,Scope,Sample Size,Sample Size Qualification,Participation,Precision");
        expected.append(",AP+CC,BL+DE,Other\n");
        expected.append("1,1,ACME,,2021-07-27,2021-07-27,Not Available,Not Available,Not Available");
        expected.append(",Not Available,1%,55%,45%,Not Available\n");
        assertEquals(expected.toString(),
                OpinionPollsCsvExporterVersion2.export(opinionPolls, null, null,
    ...
    public void shouldSortOpinionPolls() {
        ...
        expected.append("3,1,ACME,,2021-08-15,2021-08-15,Not Available,Not Available,Not Available");
        expected.append(",Not Available,1%,55%,45%,Not Available\n");
        expected.append("2,1,ACME,,2021-07-28,2021-07-28,Not Available,Not Available,Not Available");
        expected.append(",Not Available,1%,55%,45%,Not Available\n");
        expected.append("1,1,ACME,,2021-07-27,2021-07-27,Not Available,Not Available,Not Available");
        expected.append(",Not Available,1%,55%,45%,Not Available\n");
        assertEquals(expected.toString(), OpinionPollsCsvExporterVersion2.export(opinionPolls, null, null, A_AND_B_IDS,
    ...
    public void shouldExportOpinionPollWithAlternativeResponseScenario() {
        ...
        expected.append("1,2,ACME,,2021-07-27,2021-07-27,Not Available,Not Available,Not Available");
        expected.append(",Not Available,1%,50%,40%,10%,Not Available\n");
        assertEquals(expected.toString(), OpinionPollsCsvExporterVersion2.export(opinionPolls, null, null,
                A_AND_B_AND_C_IDS, OrderedCollection.<String>empty()));
    }
    ...
    public void shouldExportOpinionPollWithPublicationDateOnlyCorrectly() {
        ...
        String expected = "1,1,ACME,,2021-08-02,2021-08-02,Not Available,Not Available,Not Available"
                + ",Not Available,1%,55%,45%,Not Available";
        assertEquals(expected, OpinionPollsCsvExporterVersion2.export(poll, 1, null, null, A_AND_B,
                OrderedCollection.<String>empty()));
    }
    ...
    public void shouldExportOpinionPollWithFieldworkPeriodCorrectly() {
        ...
        String expected = "1,1,ACME,,2021-08-01,2021-08-02,Not Available,Not Available,Not Available"
                + ",Not Available,1%,55%,45%,Not Available";
        assertEquals(expected, OpinionPollsCsvExporterVersion2.export(poll, 1, null, null, A_AND_B,
                OrderedCollection.<String>empty()));
    }
    ...
    public void shouldExportResponseScenarioWithSameScopeCorrectly() {
        ...
        String expected = "1,1,ACME,,2021-08-02,2021-08-02,National,Not Available,Not Available"
                + ",Not Available,1%,55%,43%,Not Available";
        assertEquals(expected, OpinionPollsCsvExporterVersion2.export(responseScenario, poll, 1, 1, null, null, A_AND_B,
                OrderedCollection.<String>empty()));
    }
    ...
    public void shouldExportResponseScenarioWithDifferentScopeCorrectly() {
        ...
        String expected = "1,1,ACME,,2021-08-02,2021-08-02,European,Not Available,Not Available"
                + ",Not Available,1%,55%,43%,Not Available";
        assertEquals(expected, OpinionPollsCsvExporterVersion2.export(responseScenario, poll, 1, 1, null, null, A_AND_B,
                OrderedCollection.<String>empty()));
    }
    ...
    public void shouldExportOpinionPollWithSampleSizeCorrectly() {
        ...
        String expected = "1,1,ACME,,2021-08-02,2021-08-02,Not Available,1000,Provided"
                + ",Not Available,1%,55%,43%,Not Available";
        assertEquals(expected, OpinionPollsCsvExporterVersion2.export(poll, 1, null, null, A_AND_B,
                OrderedCollection.<String>empty()));
    }
    ...
    public void shouldExportOpinionPollWithExcludedResponsesCorrectly() {
        ...
        String expected = "1,1,ACME,,2021-08-02,2021-08-02,Not Available,Not Available,Not Available,90%,1%,55%,43%"
                + ",Not Available";
        assertEquals(expected, OpinionPollsCsvExporterVersion2.export(poll, 1, null, null, A_AND_B,
                OrderedCollection.<String>empty()));
    }
    ...
    public void shouldExportOpinionPollWithNoResponsesAndOtherResultCorrectly() {
        ...
        String expected = "1,1,ACME,,2021-08-02,2021-08-02,Not Available,Not Available,Not Available,92%,1%,54%,43%,2%";
        assertEquals(expected, OpinionPollsCsvExporterVersion2.export(poll, 1, null, null, A_AND_B,
                OrderedCollection.<String>empty()));
    }
    ...
    public void exportOfOpinionPollCaseU01ShouldHandleSampleSizeAndResultValues() {
        ...
        String expected =
                "1,1,ACME,,2021-08-01,2021-08-02,Not Available,1000,Provided,Not Available,1.1%,44.4%,33.3%,22.2%,Not"
                        + " Available";
        assertEquals(expected, OpinionPollsCsvExporterVersion2.export(poll, 1, null, null, A_AND_B_AND_C,
                OrderedCollection.<String>empty()));
    }
    ...
    public void exportOfResponseScenarioCaseU01ShouldHandleSampleSizeAndResultValues() {
        ...
        String expected =
                "1,1,ACME,,2021-08-01,2021-08-02,Not Available,1000,Provided,Not Available,1.1%,44.4%,33.3%,22.2%,Not"
                        + " Available";
        assertEquals(expected, OpinionPollsCsvExporterVersion2.export(responseScenario, poll, 1, 1, null, null,
                A_AND_B_AND_C, OrderedCollection.<String>empty()));
    }
    ...
    public void exportOfOpinionPollCaseU02ShouldHandleSampleSizeExcludedAndResultValues() {
        OpinionPoll poll = new OpinionPollTestBuilder().addResult("A", "40").addResult("B", "30").addResult("C", "20")
                ...
                .setFieldworkStart(DATE_OR_MONTH1).setFieldworkEnd(DATE_OR_MONTH2).build();
        String expected =
                "1,1,ACME,,2021-08-01,2021-08-02,Not Available,1250,Provided,80%,1.1%,44.4%,33.3%,22.2%,Not Available";
        assertEquals(expected, OpinionPollsCsvExporterVersion2.export(poll, 1, null, null, A_AND_B_AND_C,
                OrderedCollection.<String>empty()));
    }
    ...
    public void exportOfOpinionPollCaseU03ShouldHandleSampleSizeResultValuesAndOthers() {
        OpinionPoll poll = new OpinionPollTestBuilder().addResult("A", "40").addResult("B", "30").addResult("C", "20")
                ...
                .setFieldworkStart(DATE_OR_MONTH1).setFieldworkEnd(DATE_OR_MONTH2).build();
        String expected =
                "1,1,ACME,,2021-08-01,2021-08-02,Not Available,1000,Provided,Not Available,1.0%,40%,30%,20%,10%";
        assertEquals(expected, OpinionPollsCsvExporterVersion2.export(poll, 1, null, null, A_AND_B_AND_C,
                OrderedCollection.<String>empty()));
    }
    ...
    public void exportOfOpinionPollCaseU04ShouldHandleSampleSizeExcludedResultValuesAndOthers() {
        ...
        String expected = "1,1,ACME,,2021-08-01,2021-08-02,Not Available,1250,Provided,80%,1.0%,40%,30%,20%,10%";
        assertEquals(expected, OpinionPollsCsvExporterVersion2.export(poll, 1, null, null, A_AND_B_AND_C,
                OrderedCollection.<String>empty()));
    }
    ...
    public void exportOfOpinionPollCaseU05ShouldHandleSampleSizeResultValuesAndOthersLessThanOneHundred() {
        OpinionPoll poll = new OpinionPollTestBuilder().addResult("A", "32").addResult("B", "24").addResult("C", "16")
                ...
                .setFieldworkStart(DATE_OR_MONTH1).setFieldworkEnd(DATE_OR_MONTH2).build();
        String expected =
                "1,1,ACME,,2021-08-01,2021-08-02,Not Available,1250,Provided,Not Available,1.2%,40.0%,30.0%,20.0%,10.0%";
        assertEquals(expected, OpinionPollsCsvExporterVersion2.export(poll, 1, null, null, A_AND_B_AND_C,
                OrderedCollection.<String>empty()));
    }
    ...
    public void exportOfOpinionPollCaseU06ShouldHandleSampleSizeExcludedResultValuesAndOthersLessThanOneHundred() {
        OpinionPoll poll = new OpinionPollTestBuilder().addResult("A", "32").addResult("B", "24").addResult("C", "16")
                ...
                .setPollingFirm("ACME").setFieldworkStart(DATE_OR_MONTH1).setFieldworkEnd(DATE_OR_MONTH2).build();
        String expected =
                "1,1,ACME,,2021-08-01,2021-08-02,Not Available,1250,Provided,70%,1.2%,40.0%,30.0%,20.0%,10.0%";
        assertEquals(expected, OpinionPollsCsvExporterVersion2.export(poll, 1, null, null, A_AND_B_AND_C,
                OrderedCollection.<String>empty()));
    }
    ...
    public void exportOfOpinionPollCaseU15ShouldHandleSampleSizeResultValuesAndOthersGreaterThanOneHundred() {
        OpinionPoll poll = new OpinionPollTestBuilder().addResult("A", "80").addResult("B", "60").addResult("C", "40")
                ...
                .setFieldworkStart(DATE_OR_MONTH1).setFieldworkEnd(DATE_OR_MONTH2).build();
        String expected =
                "1,1,ACME,,2021-08-01,2021-08-02,Not Available,1000,Provided,Not Available,0.5%,40.0%,30.0%,20.0%,10.0%";
        assertEquals(expected, OpinionPollsCsvExporterVersion2.export(poll, 1, null, null, A_AND_B_AND_C,
                OrderedCollection.<String>empty()));
    }
    ...
    public void shouldExportOpinionPollWithOneCommissioner() {
        ...
        String expected = "1,1,ACME,The Times,2021-08-02,2021-08-02,Not Available,Not Available,Not Available"
                + ",Not Available,1%,55%,43%,Not Available";
        assertEquals(expected, OpinionPollsCsvExporterVersion2.export(poll, 1, null, null, A_AND_B,
                OrderedCollection.<String>empty()));
    }
    ...
    public void shouldExporOpinionPollWithTwoCommissioners() {
        ...
        String expected =
                "1,1,ACME,The Post and The Times,2021-08-02,2021-08-02,Not Available,Not Available,Not Available"
                        + ",Not Available,1%,55%,43%,Not Available";
        assertEquals(expected, OpinionPollsCsvExporterVersion2.export(poll, 1, null, null, A_AND_B,
                OrderedCollection.<String>empty()));
    }
    ...
    public void shouldExportOpinionPollWithPollingFirmAndPollingFirmPartner() {
        ...
        String expected = "1,1,ACME and EMCA,,2021-08-02,2021-08-02,Not Available,Not Available,Not Available"
                + ",Not Available,1%,55%,43%,Not Available";
        assertEquals(expected, OpinionPollsCsvExporterVersion2.export(poll, 1, null, null, A_AND_B,
                OrderedCollection.<String>empty()));
    }
    ...
    public void shouldNotExportAnOpinionPollWhenTheAreaDoesNotMatch() {
        OpinionPoll poll = new OpinionPollTestBuilder().addResult("A", "55.5").addResult("B", "43")
                .setPollingFirm("ACME").setPublicationDate(DATE).build();
        assertNull(
                OpinionPollsCsvExporterVersion2.export(poll, 1, "N", null, A_AND_B, OrderedCollection.<String>empty()));
    }
    ...
    public void shouldExportResponseScenarioWithNoResponsesAndOtherResultCorrectly() {
        ...
        String expected =
                "1,1,ACME,,2021-08-02,2021-08-02,Not Available,Not Available,Not Available" + ",92%,1%,54%,43%,2%";
        assertEquals(expected, OpinionPollsCsvExporterVersion2.export(responseScenario, poll, 1, 1, null, null, A_AND_B,
                OrderedCollection.<String>empty()));
    }
    ...
    public void shouldExportOpinionPollWithCommasInPollingFirmAndCommissionerCorrectly() {
        ...
        String expected = "1,1,\"AC,ME\",\"Times, The\",2021-08-02,2021-08-02,Not Available,Not Available,Not Available"
                + ",Not Available,1%,55%,45%,Not Available";
        assertEquals(expected, OpinionPollsCsvExporterVersion2.export(poll, 1, null, null, A_AND_B,
                OrderedCollection.<String>empty()));
    }
    ...
    public void shouldExportOpinionPollWithQuotesInPollingFirmAndCommissionerCorrectly() {
        OpinionPoll poll = new OpinionPollTestBuilder().addResult("A", "55").addResult("B", "45")
                .setPollingFirm("AC\"ME").addCommissioner("Times\" The").setPublicationDate(DATE).build();
        String expected = "1,1,\"AC\"\"ME\",\"Times\"\" The\",2021-08-02,2021-08-02,Not Available,Not Available"
    ...
    public void shouldExportAResponseScenarioWithADifferentSampleSizeCorrectly() {
        ...
        String expected = "1,1,ACME,,2021-08-02,2021-08-02,Not Available,999,Provided,Not Available,1%,55%,43%"
                + ",Not Available";
        assertEquals(expected, OpinionPollsCsvExporterVersion2.export(responseScenario, poll, 1, 1, null, null, A_AND_B,
                OrderedCollection.<String>empty()));
    }
    ...
    public void shouldExportResponseScenarioInheritingTheSpeficiedAreaFromTheOpinionPoll() {
        ...
        String expected = "1,1,ACME,,2021-08-02,2021-08-02,Not Available,Not Available,Not Available"
                + ",Not Available,1%,55%,45%,Not Available";
        assertEquals(expected, OpinionPollsCsvExporterVersion2.export(responseScenario, poll, 1, 1, "N", null, A_AND_B,
                OrderedCollection.<String>empty()));
    }
    ...
    public void shouldNotExportResponseScenarioWithDifferentAreaNotMatchingTheSpecifiedArea() {
        ...
        assertNull(OpinionPollsCsvExporterVersion2.export(responseScenario, poll, 1, 1, "N", null, A_AND_B,
                OrderedCollection.<String>empty()));
    }
}
