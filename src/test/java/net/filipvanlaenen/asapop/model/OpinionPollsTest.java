...
public class OpinionPollsTest {
    ...
    /**
     * Verifies the correct export of an opinion poll with an alternative response scenario to the PSV file format for EOPAOD.
     */
    @Test
    public void shouldExportOpinionPollWithAlternativeResponseScenarioToEopaodPsvFormat() {
        ...
        StringBuffer expected = new StringBuffer();
        expected.append("Polling firm | Commissioners | Fieldwork Start | Fieldwork End | Scope | Sample Size | Participation | Precision | A | B | C | Other\n");
