...
public class AnalysisBuilderTest {
	...
	/**
	 * Verifies that the analysis builder sets the median for an electoral list to
	 * <code>null</code>.
	 */
	@Test
	...
	/**
	 * Verifies that the analysis builder sets the confidence interval for an
	 * electoral list to <code>null</code>.
	 */
	@Test
	...
	/**
	 * <code>nullOrToString</code> should return when <code>null</code> is passed as
	 * an argument.
	 */
	@Test
	...
	/**
	 * <code>nullOrToString</code> should return the result of calling
	 * <code>toString</code> on the object passed as an argument when it isn't
	 * <code>null</code>.
	 */
	@Test
